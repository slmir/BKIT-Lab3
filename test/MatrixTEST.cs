...
namespace Lab2
{
	public class Matrix<T>
	{
		...
		/// <summary>
		/// Количество элементов по горизонтали (максимальноеколичество столбцов)
 /// </summary>
		int maxX;
		/// <summary>
		/// Количество элементов по вертикали (максимальноеколичество строк)
 /// </summary>
		int maxY;
		/// <summary>
		...
		public T this[int x, int y]
		{
			...
			get
			{
				...
				{
					return this.сheckEmpty.getEmptyElem();
				}
			}
		}
		/// <summary>
		...
		public override string ToString()
		{
			...
			for (int j = 0; j < this.maxY; j++)
			{
				...
				for (int i = 0; i < this.maxX; i++)
				{
					...
					if (!this.сheckEmpty.checkEmptyElem(this[i, j]))
					{
